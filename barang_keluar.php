<?php
    require './proses/F_barang_keluar.php';
?>
<html>
<head>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <form method="POST" class="form-group">
                                        ...
                                        <div class="d-flex justify-content-end mt-3" id="block">
                                            <button name="prosesKeluar" type="submit" class="btn btn-primary">Simpan</button>
                                        </div>
                                            ...
                                            <div class="modal-dialog modal-sm modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button name="prosesKeluar" type="submit" class="btn btn-primary">Proses</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
