...
<!-- Sidebar -->
    <div class="bg-4" id="sidebar-wrapper">
        <div class="list-group list-group-flush my-3">
            ...
            <a href="data_produk.php" class="list-group-item list-group-item-action bg-4 fw-bold <?php active('data_produk.php');?>"><i class="bi bi-laptop me-2"></i>Data Produk</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class=col>
                                <input class="form-control" name="username" type="text" value="<?php echo $rowSet['username'] ?>"><br>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class=col>
                                <input class="form-control" name="no_hp" type="number" value="<?php echo $rowSet['no_hp'] ?>"><br>
                            </div>
                        </div>
                        <div class="row mt-4">
